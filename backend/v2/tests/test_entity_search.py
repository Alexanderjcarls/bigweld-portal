...
async def test_nearest_entities_can_use_query_text_for_current_mcp_signature():
    ...
    assert mcp_client.call_tool.call_args.args[0] == "nearest_nodes"
    assert mcp_client.call_tool.call_args.args[1]["query_text"] == "case routing"
    assert mcp_client.call_tool.call_args.args[1]["k"] == 5
